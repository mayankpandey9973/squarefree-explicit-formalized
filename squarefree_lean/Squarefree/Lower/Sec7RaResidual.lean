...
private noncomputable def sec7_ra_B3q (X a j : ℝ) (d : ℝ) : ℝ :=
...
private theorem sec7_ra_B3q_Ffun_eq {P : Globals} {S : Scale P} {a d j : ℝ}
...
private theorem sec7_ra_B3q_close_Icc {X a d j : ℝ}
...
private theorem sec7_ra_Ffun_mvt_local {X a p q : ℝ}
...
private theorem sec7_ra_Ffun_upper_base_sharp {X a d : ℝ}
...
private noncomputable def sec7_ra_dBreveD (X a : ℝ) : ℕ → ℝ → ℝ
  | 0 => dBreve X a
  | 1 => dBreve' X a
  | 2 => dBreve'' X a
  | 3 => dBreve''' X a
...
private noncomputable def sec7_ra_B3H (X a j : ℝ) (l : ℕ) (d : ℝ) : ℝ :=
...
private theorem sec7_ra_B3H_hasDerivAt {P : Globals} {S : Scale P} {a d j : ℝ} {l : ℕ}
...
private theorem sec7_ra_iteratedDeriv_eq_of_chain {F : ℕ → ℝ → ℝ} {s : Set ℝ}
    (hs : IsOpen s) {n : ℕ}
...
private theorem sec7_ra_B3H_chain_open {P : Globals} {S : Scale P} {a d j : ℝ}
    (hAD : 10 * S.A ≤ S.D) (ha_lo : S.A / 5 ≤ a) (ha_hi : a ≤ 11 * S.A)
    (hd : 0 < d) (hshift : Ffun P.X a d + j ∈ sec7_tWin S) :
...
private theorem sec7_ra_Ffun_iter_hasDerivAt {P : Globals} {a r : ℝ} {m : ℕ}
...
private theorem sec7_ra_B3H_bounds12_sharp_aled {P : Globals} {S : Scale P} {a d j : ℝ}
    (hAD : 10 * S.A ≤ S.D) (ha_lo : S.A / 5 ≤ a) (ha_hi : a ≤ 11 * S.A)
    (hd : 0 < d) (ha2 : a ≤ d)
    (hshift : Ffun P.X a d + j ∈ sec7_tWin S)
    (hclose : |sec7_ra_B3q P.X a j d - d| ≤ d / 100) :
...
private theorem sec7_ra_B3H_bound3_sharp_aled {P : Globals} {S : Scale P} {a d j : ℝ}
    (hAD : 10 * S.A ≤ S.D) (ha_lo : S.A / 5 ≤ a) (ha_hi : a ≤ 11 * S.A)
    (hd : 0 < d) (ha2 : a ≤ d)
    (hshift : Ffun P.X a d + j ∈ sec7_tWin S)
    (hclose : |sec7_ra_B3q P.X a j d - d| ≤ d / 100) :
...
private theorem sec7_ra_B3H_bound4_sharp_aled {P : Globals} {S : Scale P} {a d j : ℝ}
    (hAD : 10 * S.A ≤ S.D) (ha_lo : S.A / 5 ≤ a) (ha_hi : a ≤ 11 * S.A)
    (hd : 0 < d) (ha2 : a ≤ d)
    (hshift : Ffun P.X a d + j ∈ sec7_tWin S)
    (hclose : |sec7_ra_B3q P.X a j d - d| ≤ d / 100) :
...
private theorem sec7_ra_B3H_bound5_sharp_aled {P : Globals} {S : Scale P} {a d j : ℝ}
    (hAD : 10 * S.A ≤ S.D) (ha_lo : S.A / 5 ≤ a) (ha_hi : a ≤ 11 * S.A)
    (hd : 0 < d) (ha2 : a ≤ d)
    (hshift : Ffun P.X a d + j ∈ sec7_tWin S)
    (hclose : |sec7_ra_B3q P.X a j d - d| ≤ d / 100) :
...
private noncomputable def sec7_ra_dBreve6ImageQ (a z : ℝ) : ℝ :=
  a ^ 2 + 3 * a * z + 3 * z ^ 2

private noncomputable def sec7_ra_dBreve6ImageU (a z : ℝ) : ℝ :=
  z ^ 13 * (z + a) ^ 13 * (a + 2 * z) * sec7_ra_dBreve6ImagePoly a z

private noncomputable def sec7_ra_dBreve6ImageUDeriv (a z : ℝ) : ℝ :=
...
private noncomputable def sec7_ra_dBreve6ImageK (X a z : ℝ) : ℝ :=
  (315 / (64 * X ^ 6 * a ^ 6)) *
...
private theorem sec7_ra_dBreve6ImageK_hasDerivAt {X a z : ℝ}
    (hX : X ≠ 0) (ha : a ≠ 0)
...
private theorem sec7_ra_dBreve6ImageK_eq {X a z : ℝ}
...
private theorem sec7_ra_dBreve6ImageK_deriv_bound_aled {X a d z : ℝ}
    (hX : 0 < X) (ha : 0 < a) (hd : 0 < d) (ha2 : a ≤ d)
    (hzlo : (99 / 100 : ℝ) * d ≤ z) (hzhi : z ≤ (101 / 100 : ℝ) * d) :
    |(315 / (64 * X ^ 6 * a ^ 6)) *
        (sec7_ra_dBreve6ImageUDeriv a z / sec7_ra_dBreve6ImageQ a z ^ 11 -
